...
def load_model_and_preprocessor(): 
    model_path = '5_Model_Deployment/Model_Deploy_Smaranda/GradientBoosting_best_model_full.pkl'
    preprocessor_path = '5_Model_Deployment/Model_Deploy_Smaranda/preprocessor_full.pkl'
